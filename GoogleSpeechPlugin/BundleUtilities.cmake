...
# A collection of CMake utility functions useful for dealing with .plugin
...
# Returns the nearest parent dir whose name ends with ".plugin" given the full
...
# Takes either a ".plugin" directory name or the name of an executable
# nested inside a ".plugin" directory and returns the path to the ".plugin"
...
function(get_bundle_main_executable bundle result_var)
  ...
  if(EXISTS "${bundle}/Contents/Info.plist")
    ...
    # base name as the .plugin directory:
    #
  endif()
...
function(get_dotapp_dir exe dotapp_dir_var)
  ...
  if(s MATCHES "^.*/.*\\.plugin/.*$")
    # If there is a ".plugin" parent directory,
...
function(get_bundle_and_executable app bundle_var executable_var valid_var)
  ...
  if(EXISTS "${app}")
    # Is it a directory ending in .plugin?
    if(IS_DIRECTORY "${app}")
      if(app MATCHES "\\.plugin$")
        ...
        if(EXISTS "${app}" AND EXISTS "${executable}")
          ...
          set(valid 1)
          #message(STATUS "info: handled .plugin directory case...")
        else()
          message(STATUS "warning: *NOT* handled - .plugin directory case...")
        endif()
      else()
        message(STATUS "warning: *NOT* handled - directory but not .plugin case...")
      endif()
    else()
      ...
      if(is_executable)
        ...
        if(EXISTS "${dotapp_dir}")
          ...
          set(valid 1)
          #message(STATUS "info: handled executable file in .plugin dir case...")
        else()
        ...
        message(STATUS "warning: *NOT* handled - not .plugin dir, not executable file...")
      endif()
    endif()
  else()
...
function(get_bundle_all_executables bundle exes_var)
  ...
  foreach(f ${file_list})
    ...
    # message("is_file_executable ${f} ${is_executable}")
    if(is_executable)
      set(exes ${exes} "${f}")
    endif()
  endforeach()
...
function(fixup_bundle_item resolved_embedded_item exepath dirs)
  ...
  # Ensure the item is "inside the .plugin bundle" -- it should not be fixed up if
  # it is not in the .plugin bundle... Otherwise, we'll modify files in the build
